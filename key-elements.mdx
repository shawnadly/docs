...
- **Standard:** classic academic structure (Introduction, Methodology, Results, Discussion)
- **No outline:** start blank; you can Generate Outline anytime

## Document Prompt

A short description of your topic that guides outline generation.\
**Example:** “How sleep duration affects learning outcomes in undergraduates.”
...
**Tip:** You can change tone later and use **Reword (by tone)** on selected text.
...
**Info:** Suggestions may include inline citations; they’ll sync with your References list.
...
**Tip:** Pair **Tone** \+ **Reword** to keep voice consistent.
